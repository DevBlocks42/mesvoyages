...
class Visite
{
    ...
    #[Vich\UploadableField('visites', fileNameProperty: 'imageName', size: 'imageSize')]
    ...
    {
        return $this->datecreation->format('d/m/Y') == null ? "" : $this->datecreation->format('d/m/Y');
    }
    ...
    public function validate(ExecutionContextInterface $context)
    {
        ...
        if($file != null && $file != "")
        {
            ...
            {
                $context->buildViolation("Cette image est trop lourde (500 KO max)")->atPath("imageFile")->addViolation();
            }
            $infosImage = @getimagesize($file);
            if($infosImage == false)
            {
                $context->buildViolation('Ce fichier n\'est pas une image')->atPath('imageFile')->addViolation();
            }
        }
    }
}
